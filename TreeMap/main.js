...
function visualize() {
    ...
    const svg = d3.select("#graphArea").append("svg").attr("width", w).attr("height", h).attr("id", "mainGraph");
    ...
    d3.json(url).then((data) => {
        ...
        var legend = d3.select("#graphArea").append("svg").attr("width", 1000).attr("id", "legend");
