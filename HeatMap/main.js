...
function visualize(mainData) {
    ...
    const svg = d3.select("#graphArea").append("svg").attr("width", w).attr("height", h);
    ...
    const tempScale = d3.scaleSequential(d3.interpolatePlasma).domain([minTemp, maxTemp]);
